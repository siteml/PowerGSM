...
Namespace GSM.Manager.Core
    ...
    Public Class UpdateOrchestrator
        ...
        Private Function GenerateApplyScript(version As String) As String
            ...
            L.Add("")
            L.Add("rem Swap in the staged binaries.")
            L.Add("copy /Y " & q & ".updates\" & version & "\extracted\GSM.Manager.exe" & q & " " & q & "GSM.Manager.exe" & q & " >nul")
            L.Add("if errorlevel 1 goto fail")
            L.Add("copy /Y " & q & ".updates\" & version & "\extracted\GSM.Contracts.dll" & q & " " & q & "GSM.Contracts.dll" & q & " >nul")
            L.Add("if errorlevel 1 goto fail")
            L.Add("")
